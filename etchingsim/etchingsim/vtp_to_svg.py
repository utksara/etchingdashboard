import vtk
from . import fft_reconstruct
from . import mra_reconstruct
import numpy as np
...
def intermediate_points_generation(points1, points2, weight):
    ...
    x3, y3 = mra_reconstruct.intermeidate_curve(x1, y1, x2, y2, weight)
    # x3, y3 = mra_reconstruct.intermeidate_curve(y1, x1, y2, x2, weight)
